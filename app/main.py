...
입력 채널별 화면은 app/pages/ 각 페이지에서 담당한다:
    1_카드문자_입력, 2_카카오페이_입력, 3_영수증_업로드, 4_은행이체_수동입력, 5_거래내역, 6_한눈에보기, 7_카카오_알림
...
st.caption("찍고 → AI가 읽고 → 자동 분류 → 한눈에 보기로 확인 → 카카오톡으로 리포트 받기")
...
st.markdown(
    ...
    "- **\U0001F4CA 한눈에 보기** — 주간·월간 지출·수입 추이, 카테고리별 분석\n"
